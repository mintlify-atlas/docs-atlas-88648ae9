...
<Note>
  The production backend is hosted at **https://ocipe.onrender.com/api**. If you self-host the backend, update the frontend's API base URL (`VITE_API_BASE_URL`) to point to your own deployment. See [Environment Variables](/setup/environment) for details.
</Note>
