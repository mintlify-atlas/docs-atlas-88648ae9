...
description: "Set up Ocipe's Django backend and React frontend locally using environment variables, then access the app at localhost:5173."
---
...
<Steps>
  ...
  <Step title="Set up the frontend">
    ...
    Create a `.env` file in the `frontend` directory pointing at your local backend:
